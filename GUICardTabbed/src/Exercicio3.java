...
public class Exercicio3 extends JFrame {
    public Exercicio3() {
        ...
        CardLayout cl = new CardLayout();//card layout serve pra mudarmos uma pagina para outra, e ele mostra apenas o primeiro card, mas tendo a possibilidade de trocar e nao de mostrar dois ao mesmo tempo
        ...
        JButton botao4 = new JButton("Registro");
        //adicionando os botões ao card1
        card2.add(botao3);
        card2.add(botao4);
        //adicionando o card1 ao painel 
        ...
        //criar botão no card 1
        JButton botao5 = new JButton("Inicio");
        JButton botao6 = new JButton("Login");
        //adicionando os botões ao card1
        card3.add(botao5);
        card3.add(botao6);
        //adicionando o card1 ao painel 
        ...
        //"show" é um metodo do cardlayout que possibilita sair de um card para o outro, apenas puxando o nome que vc colocou no card q foi adicionado no painel ex: painel.add(card3,"Inicio");
